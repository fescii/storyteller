        ...
        <div class="left">
          ...
          <div class="quick-info">
            <span class="top">
              ...
              <span class="dot"></span>
              <span class="service">Wedding</span>
            </span>
            <p class="location">Nairobi area, near city park</p>
          </div>
        </div>
        <div class="right">
        ...
        <div class="section bio">
          <div class="infos">
            <div class="info name">
              ...
              <p class="text">Fredrick Ochieng</p>
            </div>
            <div class="info email">
              <h3 class="label">Phone</h3>
              <p class="text">+254713253018</p>
            </div>
            <div class="info number">
              <h3 class="label">Email</h3>
              <p class="text">isfescii@gmail.com</p>
            </div>
            <div class="info package">
              <h3 class="label">Package</h3>
              <p class="text">Package II</p>
            </div>
            <div class="info other">
              <h3 class="label">Other</h3>
              <p class="text">Lorem ipsum dolor sit amet consecrate, adipisicing elit. Fuga, reprehenderit iusto! Quidem earum distinctio, tenetur nesciunt sed aperiam libero beatae sequi?</p>
            </div>
          </div>
        </div>
          ...
          <div class="infos">
            <div class="info coverage">
              <h3 class="label">Coverage</h3>
               <p class="info">About 50 - 100 people to be covered</p>
            </div>
          </div>
        </div>
      </div>
